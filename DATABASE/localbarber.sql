...
--
-- Host: localhost    Database: localbarber
-- ------------------------------------------------------
...
CREATE TABLE `barber` (
  ...
  `barber_name` varchar(45) DEFAULT NULL,
  `barber_phoneNumber` int DEFAULT NULL,
  `barber_email` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2024-04-23  3:09:06
